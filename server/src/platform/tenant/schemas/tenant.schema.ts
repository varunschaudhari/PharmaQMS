...
// timeouts). JWT *secrets* are never tenant-stored — see AuthService/EsignService, which fall
// back to the platform env config when a tenant (or a specific setting) has no override.
@Schema({ _id: false })
